...
import type { TodoList } from "../api.schemas";

export const getTodo = (
  options?: AxiosRequestConfig
): Promise<AxiosResponse<TodoList[]>> => {
  return axios.get(`/todo`, options);
};
...
export const putTodo = (
  ...
  return axios.put(`/todo`, todoList, options);
};
...
export const postTodo = (
  ...
  return axios.post(`/todo`, todoList, options);
};
